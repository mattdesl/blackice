...
},{"inherits":64,"mixes":66}],4:[function(require,module,exports){
(function (global){
var THREE = (typeof window !== "undefined" ? window.THREE : typeof global !== "undefined" ? global.THREE : null);
...
},{"as-number":19,"gl-mat4/identity":33,"gl-mat4/multiply":34,"gl-mat4/scale":35,"gl-mat4/translate":36,"gl-vec3/set":59,"glslify":61,"glslify/adapter.js":60,"inherits":64,"plucker":75,"three-effectcomposer":79,"three-sdf-text":87,"xtend":100}],5:[function(require,module,exports){
(function (global){
...
},{"clamp":30,"smoothstep":78}],6:[function(require,module,exports){
...
},{"../fonts/Exo2SemiBold.json":2,"gl-texture2d":58,"img":63}],7:[function(require,module,exports){
(function (global){
...
},{"./TextPass":4,"./is-mobile":8,"./text-data":17,"three-simplicial-complex":92,"xtend":100}],8:[function(require,module,exports){
var deviceType = require('ua-device-type')
module.exports = /(phone)|(tablet)/i.test(deviceType(navigator.userAgent))
},{"ua-device-type":95}],9:[function(require,module,exports){
(function (global){
var THREE = (typeof window !== "undefined" ? window.THREE : typeof global !== "undefined" ? global.THREE : null)
...
},{"./RigScene":3,"./animate-labels":5,"./create-text-pass":7,"./is-mobile":8,"./setup-effects":10,"./setup-floor":11,"./setup-water":12,"./three-orbit-camera":18,"as-number":19,"clamp":30,"lerp":65,"plucker":75,"smoothstep":78,"unlerp":96}],10:[function(require,module,exports){
(function (global){
var THREE = (typeof window !== "undefined" ? window.THREE : typeof global !== "undefined" ? global.THREE : null)
var EffectComposer = require('three-effectcomposer')(THREE)
...
},{"./shaders/blur":13,"./shaders/lens":15,"./shaders/pass":16,"mixes":66,"three-effectcomposer":79,"three-shader-fxaa":91}],11:[function(require,module,exports){
(function (global){
...
},{"lerp":65,"randf":77,"smoothstep":78}],12:[function(require,module,exports){
var cubeShader = {
...
},{"./create":14,"glslify":61,"glslify/simple-adapter.js":62}],14:[function(require,module,exports){
(function (global){
var THREE = (typeof window !== "undefined" ? window.THREE : typeof global !== "undefined" ? global.THREE : null)
...
},{"three-glslify":85,"xtend":100}],15:[function(require,module,exports){
var glslify = require("glslify");
...
module.exports = require("./create")(source);
},{"./create":14,"glslify":61,"glslify/simple-adapter.js":62}],16:[function(require,module,exports){
var glslify = require("glslify");
var source = require("glslify/simple-adapter.js")("\n#define GLSLIFY 1\n\nvarying vec2 vUv;\nvoid main() {\n  vUv = uv;\n  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);\n}", "\n#define GLSLIFY 1\n\nuniform sampler2D tDiffuse;\nvarying vec2 vUv;\nvoid main() {\n  gl_FragColor = texture2D(tDiffuse, vUv);\n}", [{"name":"tDiffuse","type":"sampler2D"}], []);
module.exports = require("./create")(source);
},{"./create":14,"glslify":61,"glslify/simple-adapter.js":62}],17:[function(require,module,exports){
(function (global){
var THREE = (typeof window !== "undefined" ? window.THREE : typeof global !== "undefined" ? global.THREE : null)
var mobile = require('./is-mobile')
...
},{"./is-mobile":8}],18:[function(require,module,exports){
(function (global){
var inherits = require('inherits')
var TweenMax = (typeof window !== "undefined" ? window.TweenMax : typeof global !== "undefined" ? global.TweenMax : null)
...
},{"inherits":64}],19:[function(require,module,exports){
...
},{"./reflect":39,"dup":31}],39:[function(require,module,exports){
'use strict'
...
},{"./lib/create-attributes":37,"./lib/create-uniforms":38,"./lib/reflect":39}],41:[function(require,module,exports){
...
},{"fontpath-bmfont":42,"fontpath-simple-renderer":43,"gl-sprite-batch":49,"gl-texture2d":58,"inherits":64,"texcoord":57,"xtend":100}],42:[function(require,module,exports){
function glyph(data) {
    return {
        page: data.page,
        hbx: data.xoffset,
...
},{"fontpath-renderer":44,"inherits":64}],44:[function(require,module,exports){
...
module.exports = TextRenderer;
},{"fontpath-glyph-iterator":45,"fontpath-wordwrap":47}],45:[function(require,module,exports){
...
},{"fontpath-util":46}],46:[function(require,module,exports){
...
},{"gl-aliased-vao":50,"gl-buffer":53}],49:[function(require,module,exports){
...
},{"./common":48,"./pack-rgba-float":56,"gl-white-texture":54,"mixes":66,"premultiplied-rgba":55}],50:[function(require,module,exports){
...
},{"./lib/vao-emulated.js":52}],51:[function(require,module,exports){
...
},{"./do-bind.js":51}],53:[function(require,module,exports){
"use strict"
...
},{"gl-texture2d":58,"ndarray":72}],55:[function(require,module,exports){
...
},{"number-util":74}],57:[function(require,module,exports){
...
},{"gl-shader-core":40}],61:[function(require,module,exports){
module.exports = noop
...
},{"xtend":100}],67:[function(require,module,exports){
"use strict"
...
},{"cwise-compiler":68}],68:[function(require,module,exports){
"use strict"
...
},{"uniq":71}],70:[function(require,module,exports){
"use strict"
...
},{"buffer":20,"iota-array":73}],73:[function(require,module,exports){
"use strict"
...
},{"./lib/clearmaskpass":80,"./lib/maskpass":81,"./lib/renderpass":82,"./lib/shaderpass":83,"three-copyshader":84}],80:[function(require,module,exports){
/**
 * @author alteredq / http://alteredqualia.com/
 */
...
},{"./types":86}],86:[function(require,module,exports){
var typeMap = {
    'int': 'i',
    'float': 'f',
    'ivec2': 'i2',
...
},{"./lib/renderer":88}],88:[function(require,module,exports){
...
},{"./texture-wrap":89,"as-number":19,"gl-mat4/create":32,"gl-mat4/multiply":34,"gl-mat4/scale":35,"gl-shader-core":40,"gl-sprite-text":41,"xtend":100}],89:[function(require,module,exports){
...
},{"./compiled":90,"three-glslify":85}],92:[function(require,module,exports){
var inherits = require('inherits')
...
},{"inherits":64}],93:[function(require,module,exports){
/**
...
},{"bit-twiddle":93,"buffer":20,"dup":31}],95:[function(require,module,exports){
/*
* ua-device-type
